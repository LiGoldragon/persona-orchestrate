...
impl ActorKind {
    pub fn label(self) -> &'static str {
        match self {
            ...
            ActorKind::IngressSupervisor => "IngressSupervisor",
            ...
            ActorKind::DispatchSupervisor => "DispatchSupervisor",
            ...
            ActorKind::DomainSupervisor => "DomainSupervisor",
            ...
            ActorKind::ViewSupervisor => "ViewSupervisor",
